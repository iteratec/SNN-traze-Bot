...
# Save file Options
default_dir = './game/snn/'					# Default dir if scrips are called without dir
...
tau_n = 2.							# Time constant of reward signal in ms
tau_c = 100.						# Time constant of eligibility trace in ms
